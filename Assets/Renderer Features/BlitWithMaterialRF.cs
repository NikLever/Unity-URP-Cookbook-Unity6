...
public class BlitWithMaterialRF : ScriptableRendererFeature
{
    class BlitWithMaterialPass : ScriptableRenderPass
    {
        ...
        {
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle src;
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle dst;
        ...
        private void InitPassData(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ContextContainer frameData, ref PassData passData)
        {
            ...
            UnityEngine.Rendering.RenderGraphModule.TextureHandle destination = UniversalRenderer.CreateRenderGraphTexture(renderGraph, desc, "BlitMaterialTexture", false);
        ...
        public override void RecordRenderGraph(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            using (var builder = renderGraph.AddRasterRenderPass<PassData>(passName, out var passData))
            {
                ...
                // Setup as a render target via UseTexture, which is the equivalent of using the old cmd.SetRenderTarget
                ...
                builder.SetRenderFunc((PassData data, UnityEngine.Rendering.RenderGraphModule.RasterGraphContext context) => ExecutePass(data, context));
            }
        }
    }
